...
HD_PWD='C:/Users/moshi/Downloads/TalkFile_W5.zip/W5_2/W5_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stepmotor_ctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stepmotor_ctrl.tcl -notrace
