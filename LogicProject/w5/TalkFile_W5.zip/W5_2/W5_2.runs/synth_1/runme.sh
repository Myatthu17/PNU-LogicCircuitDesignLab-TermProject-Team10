...
HD_PWD='C:/Users/moshi/Downloads/TalkFile_W5.zip/W5_2/W5_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stepmotor_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stepmotor_ctrl.tcl
