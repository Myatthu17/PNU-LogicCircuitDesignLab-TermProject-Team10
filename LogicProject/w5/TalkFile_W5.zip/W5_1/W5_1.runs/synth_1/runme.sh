...
HD_PWD='C:/Users/moshi/Downloads/TalkFile_W5.zip/W5_1/W5_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_dnup.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_dnup.tcl
