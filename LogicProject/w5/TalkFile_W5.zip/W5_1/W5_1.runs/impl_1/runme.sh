...
HD_PWD='C:/Users/moshi/Downloads/TalkFile_W5.zip/W5_1/W5_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_dnup.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_dnup.tcl -notrace
