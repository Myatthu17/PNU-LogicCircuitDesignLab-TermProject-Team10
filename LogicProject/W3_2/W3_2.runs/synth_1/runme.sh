...
HD_PWD='C:/Users/myatt/Desktop/LogicProject/W3_2/W3_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decimal_to_binary.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decimal_to_binary.tcl
