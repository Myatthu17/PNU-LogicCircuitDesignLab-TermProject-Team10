...
HD_PWD='C:/Users/myatt/Desktop/LogicProject/W3_2/W3_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decimal_to_binary.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decimal_to_binary.tcl -notrace
