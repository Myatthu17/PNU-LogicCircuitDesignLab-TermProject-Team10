...
HD_PWD='C:/Users/myatt/Desktop/LogicProject/W5_2/W5_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stepper_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stepper_control.tcl
