...
HD_PWD='C:/Users/myatt/Desktop/LogicProject/W5_2/W5_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stepper_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stepper_control.tcl -notrace
