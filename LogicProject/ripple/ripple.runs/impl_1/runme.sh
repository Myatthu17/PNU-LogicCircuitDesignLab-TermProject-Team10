...
HD_PWD='C:/Users/myatt/OneDrive/Desktop/LogicProject/ripple/ripple.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple_adder_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ripple_adder_4bit.tcl -notrace
