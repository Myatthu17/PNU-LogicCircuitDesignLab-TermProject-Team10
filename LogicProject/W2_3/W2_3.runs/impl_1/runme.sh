...
HD_PWD='C:/Users/myatt/OneDrive/Desktop/LogicProject/W2_3/W2_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mult_4bit.tcl -notrace
