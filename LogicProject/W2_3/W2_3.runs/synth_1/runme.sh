...
HD_PWD='C:/Users/myatt/OneDrive/Desktop/LogicProject/W2_3/W2_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_4bit.tcl
